module.exports = function(grunt) {
    ...
    concat: {
        options: {
            ...
            wp_erp_pdf: {
                src: [
                    'assets/js/vendor/*.js',
                    'assets/js/src/wp-erp-pdf.js',
                ],
                    dest: 'assets/js/wp-erp-pdf.js'
            }
        },
    // jshint
    jshint: {
    ...
    uglify: {
        all: {
            files: {
                'assets/js/wp-erp-pdf.min.js': ['assets/js/wp-erp-pdf.js']
            },
            options: {
        ...
        sass:   {
            all: {
                files: {
                    'assets/css/wp-erp-pdf.css': 'assets/css/sass/wp-erp-pdf.scss'
                }
            }
        },
            ...
            target: {
                options: {
                    exclude: ['build/.*', 'node_modules/*', 'assets/*'],
                        ...
                        potFilename: 'wp-erp-pdf.pot', // Name of the POT file.
